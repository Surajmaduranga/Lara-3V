...
module.exports = {
    OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94763933826' : process.env.OWNER_NUMBER, //ADD YOUR NUMBER
    SESSION_ID: process.env.SESSION_ID === undefined ? 'EJ4iSJjD#nsJwP46q6PWKcePBMOQX3Z40Zd_LmuyI-1iPlI_rkdA' : process.env.SESSION_ID, //ADD YOUR SSION ID
